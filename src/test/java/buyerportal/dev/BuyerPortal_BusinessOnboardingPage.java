...
public class BuyerPortal_BusinessOnboardingPage {
	...
	private By checkbox=By.xpath("//span[text()='I am authorised to create an account with Proxtera.']");
...
//	private By countryofincorporation=By.xpath("//input[@id=\"country_of_incorporation\"]");
	...
	private By companywebsite=By.xpath("//input[@name=\"website\"]");
	private By PrimaryIndustry=By.xpath("(//input[@role=\"combobox\"])[4]");
	...
	private By companydescription=By.xpath("//textarea[@name=\"about_information\"]");
...
//	
	private By location=By.xpath("//input[@role=\"combobox\"]");
...
//
      ...
      private By awardname=By.xpath("//input[@name=\"award_name\"]");
...
//
      ...
      private By headline=By.xpath("//input[@name=\"news_headline\"]");
...
//    
      ...
      private By continue_source=By.xpath("//button[text()='Continue Sourcing']");
...
//		reusable.uploadrobot( filepath1);
	//	reusable.click(designation);
		...
		reusable.click(continue_source);
